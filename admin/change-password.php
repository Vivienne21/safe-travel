...
<!--heder end here-->
	<ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="dashboard.php">Home</a><i class="fa fa-angle-right"></i>Profil <i class="fa fa-angle-right"></i> Schimbă Parola</li>
            </ol>
		<!--grid-->
 	<div class="grid-form">
  ...
  <div class="panel-body">
					<form  name="chngpwd" method="post" class="form-horizontal" onSubmit="return valid();">
						...
						<div class="form-group">
							<label class="col-md-2 control-label">Parola Curentă</label>
							<div class="col-md-8">
	...
	<div class="form-group">
							<label class="col-md-2 control-label">Noua Parolă</label>
							<div class="col-md-8">
								<div class="input-group">
									<span class="input-group-addon">
										<i class="fa fa-key"></i>
	...
	<div class="form-group">
							<label class="col-md-2 control-label">Confirmă Parola</label>
							<div class="col-md-8">
								<div class="input-group">
									<span class="input-group-addon">
										<i class="fa fa-key"></i>
				...
				<button type="reset" class="btn-inverse btn">Resetează</button>
			</div>
		</div>
