...
{
$error="Nu puteti anula rezervarea cu o 24h inainte";
}
}
}
}
...
<div class="privacy">
	<div class="container">
		<h3 class="wow fadeInDown animated animated" data-wow-delay=".5s" style="visibility: visible; animation-delay: 0.5s; animation-name: fadeInDown;">Istoric</h3>
...
{
echo "Anulat de tine la " .$result->upddate;
} 
if($result->status==2 and $result->cancelby=='a')
{
echo "Anulat de Admin la " .$result->upddate;
...
<?php if($result->status==2)
{
	?><td>Anulat</td>
<?php } else {?>
<td><a href="tour-history.php?bkid=<?php echo htmlentities($result->bookid);?>" onclick="return confirm('Sunteti sigur ca vreti sa anulati rezervarea?')" >Cancel</a></td>
<?php }?>
</tr>
<?php $cnt=$cnt+1; }} ?>
	</table>
